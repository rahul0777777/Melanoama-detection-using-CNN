...
from tensorflow.python.keras.layers import Dense, Flatten, Conv2D, MaxPool2D, Dropout, BatchNormalization
...
# Define paths
path_train = 'C:/verynewprojectfile/inputs/train'
path_test = 'C:/verynewprojectfile/inputs/test'
...
image_path = 'C:/verynewprojectfile/inputs/train/benign/melanoma_13.jpg'  # Replace with the path to the image you want to check
